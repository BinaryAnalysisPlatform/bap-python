...
class Exp(ADT):
    pass  # Abstract base for all expressions
...
class UnOp(Exp):
    pass  # Abstract base for all unary operators
...
class Stmt(ADT):
    pass  # Abstract base for all statements
...
class Type(ADT):
    pass  # Abstract base for expression type
